...
const Services2D3D = () => {
  ...
  const processSteps = [
    {
      ...
      checklist: ["We understand your brand, campaign objectives, and audience expectations."],
    ...
    },
    {
      ...
      checklist: ["We shape bold ideas into visual storylines designed to captivate and convert."],
    ...
    },
    {
      ...
      checklist: ["From 3D modeling to AR filters or VR environments, we build custom assets that match your campaign tone."],
    ...
    },
    {
      ...
      checklist: ["We develop and deploy immersive content across your preferred platforms web, mobile, or headset-based."],
    ...
    },
    {
      ...
      checklist: ["We test for performance and usability across devices, then launch with full marketing support."],
    ...
    },
    {
      ...
      checklist: ["Track user engagement and improve campaign performance with real time feedback and A/B testing."],
  ...
  // =========================
  const whyChoose = [
    { title: "Full Funnel Thinking", desc: "We go beyond vanity metrics and build strategies that cover every stage awareness to retention." },
    { title: "Custom Strategy, Not Copy-Paste", desc: "Every plan is tailored to your business model, industry, audience, and growth goals." },
    { title: "Creative Meets Technology", desc: "We combine design thinking with emerging tech to deliver campaigns that leave a lasting impression." },
    { title: "Multi-Platform Reach", desc: "From social filters to headset VR to WebAR we make sure your audience can access your campaign anywhere." },
    { title: "Custom Strategies for Every Brand", desc: "Whether you're launching a product or building long term brand affinity, we design immersive journeys to match your business goals." },
    { title: "Analytics-Driven Improvements", desc: "We provide detailed reports and engagement data to help you measure impact and improve performance." },
    { title: "Collaborative Process, Start to Finish", desc: "You're part of every creative and technical decision ensuring the final result reflects your brand perfectly." }
  ];
  ...
  // =========================
  const faqs = [
    { q: "What is immersive marketing exactly?", a: "Immersive marketing uses technologies like AR, VR, and 3D to create interactive and memorable brand experiences." },
    { q: "Is it suitable for small businesses or only big brands?", a: "It's for everyone! We offer scalable solutions based on your budget and audience." },
    { q: "Do users need special devices to experience it?", a: "Not always. We also build WebAR or mobile experiences that run on regular smartphones." },
    { q: "Can immersive marketing increase conversions?", a: "Yes—studies show that interactive content boosts engagement and conversion rates significantly." },
    { q: "How long does it take to launch a campaign?", a: "Depending on complexity, it can take anywhere from 2 to 8 weeks. We'll give you a clear timeline upfront." }
  ];
